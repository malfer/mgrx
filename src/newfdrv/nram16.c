/**
 ** nram16.c ---- the new 24bpp linear in-memory and
...
GrFrameDriver _GrFrameDriverNRAM16 = {
    GR_frameNRAM16,             /* frame mode */
...
GrFrameDriver _GrFrameDriverNLFB16 = {
    GR_frameNLFB16,             /* frame mode */
    GR_frameNRAM16,             /* compatible RAM frame mode */
    TRUE,                       /* onscreen */
