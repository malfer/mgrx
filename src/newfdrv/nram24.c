/**
 ** nram24.c ---- the new 24bpp linear in-memory and
...
GrFrameDriver _GrFrameDriverNRAM24 = {
    GR_frameNRAM24,             /* frame mode */
...
GrFrameDriver _GrFrameDriverNLFB24 = {
    GR_frameNLFB24,             /* frame mode */
