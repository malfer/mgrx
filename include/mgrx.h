...
#define MGRX_VERSION_API 0x0151
...
extern const struct _GR_driverInfo {
        ...
        int     minwgw,minwgh;              /* min window size */
} * const GrDriverInfo;
 ...
 */
#define GR_BYTE_TEXT            0   /* 1 byte per character, unknown encoding */
#define GR_WORD_TEXT            1   /* 2 bytes per character, unknown encoding */
#define GR_CP437_TEXT           2   /* 1 bpc standard DOS encoding */
#define GR_CP850_TEXT           3   /* 1 bpc latin1 DOS encoding */
#define GR_CP1252_TEXT          4   /* 1 bpc standard Latin Win encoding */
...
#define GR_CP1251_TEXT          8   /* 1 bpc standard Cyrillic Win encoding */
#define GR_CP1253_TEXT          9   /* 1 bpc standard Greek Win encoding */
 ...
 */
#define GR_FONTENC_UNKNOWN     0     /* unknown encoding (no recode) */
#define GR_FONTENC_CP437       1     /* standard dos encoding */
#define GR_FONTENC_CP850       2     /* standard dos encoding */
#define GR_FONTENC_CP1252      3     /* standard Latin Win encoding */
...
#define GR_FONTENC_CP1251     10     /* standard Cyrillic Win encoding */
#define GR_FONTENC_CP1253     11     /* standard Greek Win encoding */
#define GR_FONTENC_LASTENC    11     /* last encoding, for checks */
...
#define GRENC_CP1252         2   /* standard Latin Win encoding */
...
#define GRENC_CP1251         6   /* standard Cyrillic Win encoding */
#define GRENC_CP1253         7   /* standard Greek Win encoding */
#define GRENC_LASTENCODE     7   /* last encode, for checks */
...
/*
 * These functions are global, not only kb related, keys are recoded to user encoding
...
#define GR_MCUR_TYPE_ARROW  0      /* MOUSE CURSOR internal types: arrow cursor */
